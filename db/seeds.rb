...
# Favourite.create(user_id: 1, book_id: 1)
# Favourite.create(user_id: 1, book_id: 2)
# Favourite.create(user_id: 2, book_id: 3)
# Favourite.create(user_id: 2, book_id: 4)
# Favourite.create(user_id: 3, book_id: 5)
# # Find the user
# user = User.find(1)

# # Create a FavoriteBook instance with the desired book
# favourite_book = Favourite.new(user: user, book: Book.find(3))
